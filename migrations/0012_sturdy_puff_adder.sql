...
ALTER TABLE "locations" ALTER COLUMN "latitude" SET DATA TYPE numeric(10, 8);--> statement-breakpoint
ALTER TABLE "locations" ALTER COLUMN "longitude" SET DATA TYPE numeric(11, 8);--> statement-breakpoint
