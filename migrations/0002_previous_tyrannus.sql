ALTER TABLE "locations" ALTER COLUMN "latitude" SET DATA TYPE numeric(9, 6);--> statement-breakpoint
ALTER TABLE "locations" ALTER COLUMN "longitude" SET DATA TYPE numeric(9, 6);--> statement-breakpoint
